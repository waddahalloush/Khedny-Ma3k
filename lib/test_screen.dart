...
import 'View/Screens/Main Screen/Widgets/find_ride_form_widget.dart';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text("The cost of adding the Trip",
                        ...
                        return TextFormField(
                          ...
                          onTap: () {
                            showMaterialNumberPicker(
                                context: context,
                                title: 'Pick Price per Passenger',
                                maxNumber: 50000,
                                minNumber: 1000,
                                step: 500,
                                selectedNumber: 1000,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(4.0),
                    child: Text("  Safety notice",
                        style: Theme.of(context).primaryTextTheme.bodyText2),
                  ),
                  TextFormField(
                    style: const TextStyle(fontSize: 12),
                    maxLines: 2,
                    initialValue: "I may be late about 10 minutes",
                    decoration: const InputDecoration(
                      constraints: BoxConstraints(maxHeight: 80),
                      enabledBorder: OutlineInputBorder(),
                      focusedBorder: OutlineInputBorder(),
